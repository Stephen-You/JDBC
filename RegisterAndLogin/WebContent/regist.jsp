...
<%-- 还要显示回显数据 --%>
<form action="/RegisterAndLogin/RegistServlet" method="post" id="form">
...
密码：　　<input type="password" name="password" value="${user.password }"/>
		<span id="passwordError" style="color: red; font-size: 10pt; font-weight: 900;">${map.password }</span>
<br/>
...
验证码：　<input type="text" name="verifyCode" size="3" value="${user.verifyCode }"/><br/>
       <img src="/RegisterAndLogin/VerifyCodeServlet" id="img1"/>　
